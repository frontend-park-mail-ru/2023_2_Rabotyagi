...
/* harmony export */ });
/* harmony import */ var _shared_utils_parsing_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../shared/utils/parsing.js */ "./src/shared/utils/parsing.js");
/* harmony import */ var _card_hbs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./card.hbs */ "./src/components/card/card.hbs");
/* harmony import */ var _card_hbs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_card_hbs__WEBPACK_IMPORTED_MODULE_1__);
...
class Card {
  ...
  render() {
    const template = (_card_hbs__WEBPACK_IMPORTED_MODULE_1___default());
    const context = {
      badges: {
        safeDeal: false,
        delivery: false,
    ...
    return (0,_shared_utils_parsing_js__WEBPACK_IMPORTED_MODULE_0__.stringToElement)(template(context));
  }
}

/***/ }),

/***/ "./src/components/error/errorMessageBox.js":
/*!*************************************************!*\
  !*** ./src/components/error/errorMessageBox.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ErrorMessageBox: () => (/* binding */ ErrorMessageBox)
/* harmony export */ });
/* harmony import */ var _shared_utils_parsing_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../shared/utils/parsing.js */ "./src/shared/utils/parsing.js");
/* harmony import */ var _errorMessageBox_hbs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./errorMessageBox.hbs */ "./src/components/error/errorMessageBox.hbs");
/* harmony import */ var _errorMessageBox_hbs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_errorMessageBox_hbs__WEBPACK_IMPORTED_MODULE_1__);


const ErrorMessageBox = error => {
  const template = (_errorMessageBox_hbs__WEBPACK_IMPORTED_MODULE_1___default());
  return (0,_shared_utils_parsing_js__WEBPACK_IMPORTED_MODULE_0__.stringToElement)(template({
    text: error
  }));
};
...
/* harmony export */ });
/* harmony import */ var _card_card_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../card/card.js */ "./src/components/card/card.js");
/* harmony import */ var _error_errorMessageBox_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../error/errorMessageBox.js */ "./src/components/error/errorMessageBox.js");
/* harmony import */ var _shared_api_post_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/api/post.js */ "./src/shared/api/post.js");
/* harmony import */ var _loader_loader_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../loader/loader.js */ "./src/components/loader/loader.js");
/* harmony import */ var _shared_utils_parsing_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../shared/utils/parsing.js */ "./src/shared/utils/parsing.js");
/* harmony import */ var _feed_hbs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./feed.hbs */ "./src/components/feed/feed.hbs");
/* harmony import */ var _feed_hbs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_feed_hbs__WEBPACK_IMPORTED_MODULE_5__);
/**
 * @module Feed
 */
...
class Feed {
  async getPosts(container) {
    try {
      const resp = await _shared_api_post_js__WEBPACK_IMPORTED_MODULE_2__.Post.feed();
      if (resp.status != 200) {
        throw resp.body.error;
      }
      container.innerHTML = '';
      resp.body.forEach(elem => {
        container.appendChild(new _card_card_js__WEBPACK_IMPORTED_MODULE_0__.Card(elem).render());
      });
    } catch (err) {
      container.innerHTML = '';
      container.appendChild((0,_error_errorMessageBox_js__WEBPACK_IMPORTED_MODULE_1__.ErrorMessageBox)(err));
    }
  }
  render() {
    const template = (_feed_hbs__WEBPACK_IMPORTED_MODULE_5___default());
    const context = {
      feedName: 'Все объявления'
    };
    const root = (0,_shared_utils_parsing_js__WEBPACK_IMPORTED_MODULE_4__.stringToElement)(template(context));
    const container = root.querySelector('div.feed-content');
    container.appendChild((0,_loader_loader_js__WEBPACK_IMPORTED_MODULE_3__.loaderRegular)());
...
/* harmony export */ });
/* harmony import */ var _shared_store_store_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../shared/store/store.js */ "./src/shared/store/store.js");
/* harmony import */ var _shared_utils_cookie_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../shared/utils/cookie.js */ "./src/shared/utils/cookie.js");
/* harmony import */ var _shared_utils_parsing_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/utils/parsing.js */ "./src/shared/utils/parsing.js");
/* harmony import */ var _profileBtn_profileBtn_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../profileBtn/profileBtn.js */ "./src/components/profileBtn/profileBtn.js");
/* harmony import */ var _header_hbs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./header.hbs */ "./src/components/header/header.hbs");
/* harmony import */ var _header_hbs__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_header_hbs__WEBPACK_IMPORTED_MODULE_4__);
/**
 * @file header.js
 * @module Header
 */
...
class Header {
   ...
   */
  render() {
    const template = (_header_hbs__WEBPACK_IMPORTED_MODULE_4___default());
    const profileBtn = new _profileBtn_profileBtn_js__WEBPACK_IMPORTED_MODULE_3__.ProfileBtn();
    const context = {
      signin: {
        caption: 'Войти'
      },
      ...
      authorized: _shared_store_store_js__WEBPACK_IMPORTED_MODULE_0__.store.user.isAuth(),
      profile: profileBtn.render()
    };
    const root = (0,_shared_utils_parsing_js__WEBPACK_IMPORTED_MODULE_2__.stringToElement)(template(context));
    root.querySelectorAll('button[data-link]').forEach(item => item.addEventListener('click', e => {
      e.stopPropagation();
    ...
    root.querySelector('#dropdown-btn-logout')?.addEventListener('click', e => {
      e.stopPropagation();
      _shared_store_store_js__WEBPACK_IMPORTED_MODULE_0__.store.user.clear();
      (0,_shared_utils_cookie_js__WEBPACK_IMPORTED_MODULE_1__.deleteCookie)('access_token');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   loaderRegular: () => (/* binding */ loaderRegular)
/* harmony export */ });
const loaderRegular = () => {
...
/***/ "./src/components/profileBtn/profileBtn.js":
/*!*************************************************!*\
  !*** ./src/components/profileBtn/profileBtn.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ProfileBtn: () => (/* binding */ ProfileBtn)
/* harmony export */ });
/* harmony import */ var _profileBtn_hbs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profileBtn.hbs */ "./src/components/profileBtn/profileBtn.hbs");
/* harmony import */ var _profileBtn_hbs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_profileBtn_hbs__WEBPACK_IMPORTED_MODULE_0__);

class ProfileBtn {
  render() {
    const template = (_profileBtn_hbs__WEBPACK_IMPORTED_MODULE_0___default());
    const context = {
      dropdown: {
        id: 'profile-dropdown',
        search: false,
        items: {
          ref: 'profileBtn',
          content: [['dropdown-btn-fav', 'Избранное'], ['dropdown-btn-profile', 'Профиль'], ['dropdown-btn-logout', 'Выйти']]
        }
      }
    };
...
/* harmony import */ var _components_feed_feed_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../components/feed/feed.js */ "./src/components/feed/feed.js");
/**
 * @module mainPage
 * @file main.js
 */
...
class MainPage {
  render() {
    ...
    const header = new _components_header_header_js__WEBPACK_IMPORTED_MODULE_0__.Header();
    const feed = new _components_feed_feed_js__WEBPACK_IMPORTED_MODULE_1__.Feed(root);
...
/* harmony import */ var _shared_store_store_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../shared/store/store.js */ "./src/shared/store/store.js");
/* harmony import */ var _shared_utils_cookie_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../shared/utils/cookie.js */ "./src/shared/utils/cookie.js");
/* harmony import */ var _shared_utils_validation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/utils/validation.js */ "./src/shared/utils/validation.js");
/* harmony import */ var _components_error_errorMessageBox_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/error/errorMessageBox.js */ "./src/components/error/errorMessageBox.js");
/* harmony import */ var _shared_api_auth_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../shared/api/auth.js */ "./src/shared/api/auth.js");
/* harmony import */ var _shared_utils_parsing_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared/utils/parsing.js */ "./src/shared/utils/parsing.js");
/* harmony import */ var _signin_hbs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./signin.hbs */ "./src/pages/signin/signin.hbs");
/* harmony import */ var _signin_hbs__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_signin_hbs__WEBPACK_IMPORTED_MODULE_6__);
/**
 * @module signinPage
 * @file signin.js
 */
...
class SigninPage {
  ...
  #check(email, pass) {
    email = email.trim();
    pass = pass.trim();
    const errEmail = (0,_shared_utils_validation_js__WEBPACK_IMPORTED_MODULE_2__.validateEmail)(email);
    if (errEmail) {
      return errEmail;
    }
    const errPassword = (0,_shared_utils_validation_js__WEBPACK_IMPORTED_MODULE_2__.validatePassword)(pass);
    if (errPassword) {
      return errPassword;
    }
    return null;
  ...
  async signin(email, pass, errorBox) {
    try {
      const resp = await _shared_api_auth_js__WEBPACK_IMPORTED_MODULE_4__.Auth.signin(email, pass);
      if (resp.status != 200) {
        throw resp.body.error;
      }
      const cookies = (0,_shared_utils_cookie_js__WEBPACK_IMPORTED_MODULE_1__.cookieParser)(document.cookie);
      _shared_store_store_js__WEBPACK_IMPORTED_MODULE_0__.store.user.login(cookies);
      Router.navigateTo('/');
    } catch (err) {
      errorBox.innerHTML = '';
      errorBox.appendChild((0,_components_error_errorMessageBox_js__WEBPACK_IMPORTED_MODULE_3__.ErrorMessageBox)(err));
    }
  }
   ...
   */
  render() {
    const template = (_signin_hbs__WEBPACK_IMPORTED_MODULE_6___default());
    const context = {
      buttons: {
        submit: 'Продолжить',
        toReg: 'Регистрация'
    ...
    const root = (0,_shared_utils_parsing_js__WEBPACK_IMPORTED_MODULE_5__.stringToElement)(template(context));
    document.title = 'Вход';
    const container = root.querySelector('div.right-block-content');
    container.querySelectorAll('button[data-link]').forEach(item => item.addEventListener('click', e => {
      e.stopPropagation();
      Router.navigateTo(item.dataset.link);
    }, {
      capture: false
    ...
    container.querySelector('#btnSubmit').addEventListener('click', () => {
      ...
      if (error) {
        errorBox.innerHTML = '';
        errorBox.appendChild((0,_components_error_errorMessageBox_js__WEBPACK_IMPORTED_MODULE_3__.ErrorMessageBox)(error));
        return;
      }
...
/* harmony import */ var _shared_utils_cookie_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../shared/utils/cookie.js */ "./src/shared/utils/cookie.js");
/* harmony import */ var _shared_utils_validation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/utils/validation.js */ "./src/shared/utils/validation.js");
/* harmony import */ var _shared_api_auth_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/api/auth.js */ "./src/shared/api/auth.js");
/* harmony import */ var _components_error_errorMessageBox_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components/error/errorMessageBox.js */ "./src/components/error/errorMessageBox.js");
/* harmony import */ var _shared_utils_parsing_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared/utils/parsing.js */ "./src/shared/utils/parsing.js");
/* harmony import */ var _signup_hbs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./signup.hbs */ "./src/pages/signup/signup.hbs");
/* harmony import */ var _signup_hbs__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_signup_hbs__WEBPACK_IMPORTED_MODULE_6__);
/**
 * @module signupPage
 * @file signupPage.js
 */
...
class SignupPage {
  ...
  async signup(email, pass, errorBox) {
    try {
      const resp = await _shared_api_auth_js__WEBPACK_IMPORTED_MODULE_3__.Auth.signup(email, pass);
      if (resp.status != 200) {
        throw resp.body.error;
      }
      const cookies = (0,_shared_utils_cookie_js__WEBPACK_IMPORTED_MODULE_1__.cookieParser)(document.cookie);
      ...
      errorBox.innerHTML = '';
      errorBox.appendChild((0,_components_error_errorMessageBox_js__WEBPACK_IMPORTED_MODULE_4__.ErrorMessageBox)(err));
    }
  }
   ...
   */
  render() {
    const template = (_signup_hbs__WEBPACK_IMPORTED_MODULE_6___default());
    const context = {
      buttons: {
        submit: 'Продолжить'
      }
    ...
    container.querySelector('#btnSubmit').addEventListener('click', e => {
      ...
      if (error) {
        errorBox.innerHTML = '';
        errorBox.appendChild((0,_components_error_errorMessageBox_js__WEBPACK_IMPORTED_MODULE_4__.ErrorMessageBox)(error));
        return;
      }
...
/* harmony export */ });
/* harmony import */ var _constants_api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constants/api.js */ "./src/shared/constants/api.js");
/* harmony import */ var _services_ajax_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/ajax.js */ "./src/shared/services/ajax.js");
/**
 * @file auth.js
 * @module Api.Auth
 */
...
const Auth = {
  ...
  signin: async ({
    ...
    return await _services_ajax_js__WEBPACK_IMPORTED_MODULE_1__["default"].post({
      url: _constants_api_js__WEBPACK_IMPORTED_MODULE_0__.API.SIGNIN,
      body: JSON.stringify({
        email: email,
        password: password
      }),
  ...
  signup: async ({
    ...
    return await _services_ajax_js__WEBPACK_IMPORTED_MODULE_1__["default"].post({
      url: _constants_api_js__WEBPACK_IMPORTED_MODULE_0__.API.SIGNUP,
      body: JSON.stringify({
        email: email,
        password: password
      }),
...
const Post = {
  feed: async () => {
    return await _services_ajax_js__WEBPACK_IMPORTED_MODULE_1__["default"].get({
      url: _constants_api_js__WEBPACK_IMPORTED_MODULE_0__.API.POST_LIST,
      params: {
        count: 20
      }
    });
...
/* harmony export */ });
/* harmony import */ var _user_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user.js */ "./src/shared/store/user.js");
/**
 * @file store.mjs
 * @module Store
 */
 ...
 */
const store = {
  user: _user_js__WEBPACK_IMPORTED_MODULE_0__.user
};

/***/ }),

/***/ "./src/shared/store/user.js":
/*!**********************************!*\
  !*** ./src/shared/store/user.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _utils_cookie_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/cookie.js */ "./src/shared/utils/cookie.js");
...
const user = {
   ...
   */
  init: () => {
    const cookie = (0,_utils_cookie_js__WEBPACK_IMPORTED_MODULE_0__.cookieParser)(document.cookie);
    if (cookie) {
      user.login(cookie);
    }
  },
  ...
  login: ({
    ...
    const decoded = (0,jwt_decode__WEBPACK_IMPORTED_MODULE_1__["default"])(access_token);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   cookieParser: () => (/* binding */ cookieParser),
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class='card'>\r\n    <div class='badges'>\r\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,((stack1 = (depth0 != null ? lookupProperty(depth0,"badges") : depth0)) != null ? lookupProperty(stack1,"safeDeal") : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":3,"column":8},"end":{"line":5,"column":15}}})) != null ? stack1 : "")
    + "\r\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,((stack1 = (depth0 != null ? lookupProperty(depth0,"badges") : depth0)) != null ? lookupProperty(stack1,"delivery") : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":7,"column":8},"end":{"line":11,"column":15}}})) != null ? stack1 : "")
    + "\r\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,((stack1 = (depth0 != null ? lookupProperty(depth0,"badges") : depth0)) != null ? lookupProperty(stack1,"city") : stack1),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":13,"column":8},"end":{"line":17,"column":15}}})) != null ? stack1 : "")
    + "    </div>\r\n    <div class='card-body'>\r\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"img") : depth0),{"name":"if","hash":{},"fn":container.program(7, data, 0),"inverse":container.program(9, data, 0),"data":data,"loc":{"start":{"line":20,"column":8},"end":{"line":40,"column":15}}})) != null ? stack1 : "")
...
/***/ "./src/components/dropdown/dropdown.hbs":
/*!**********************************************!*\
  !*** ./src/components/dropdown/dropdown.hbs ***!
  \**********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./src/components/error/errorMessageBox.hbs":
/*!**************************************************!*\
  !*** ./src/components/error/errorMessageBox.hbs ***!
  \**************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"feed\">\r\n    <div class=\"feed-header\">\r\n        <span class=\"text-header\">"
    + container.escapeExpression(container.lambda((depth0 != null ? lookupProperty(depth0,"feedName") : depth0), depth0))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        "
    + ((stack1 = container.lambda((depth0 != null ? lookupProperty(depth0,"profile") : depth0), depth0)) != null ? stack1 : "")
    + "\r\n";
},"3":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return "<nav>\r\n    <button data-link='/' class='logo-box'>\r\n        <div\r\n            style='background-image: url(assets/icons/logo.svg); width: 60px; height: 60px;'\r\n        ></div>\r\n        <span class='text-subheader'>Супер Юла</span>\r\n    </button>\r\n    <button class='btn-primary'><span\r\n            class='text-regular'\r\n        >Категории</span></button>\r\n    <div class='search-box'>\r\n        <input\r\n            class='search-input text-regular searchField'\r\n            placeholder='Поиск'\r\n        />\r\n    </div>\r\n    <button class='btn-neutral'><span class='text-regular'>Разместить объявление</span></button>\r\n"
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"authorized") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data,"loc":{"start":{"line":18,"column":4},"end":{"line":29,"column":11}}})) != null ? stack1 : "")
    + "</nav>";
},"useData":true});

/***/ }),

/***/ "./src/components/profileBtn/profileBtn.hbs":
/*!**************************************************!*\
  !*** ./src/components/profileBtn/profileBtn.hbs ***!
  \**************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"profile-container\">\r\n    <div class=\"profile-btn\" style=\"background-image: url(assets/images/avatar-placeholder.png); background-size: contain;\"></div>\r\n"
    + ((stack1 = container.invokePartial(__webpack_require__(/*! ../dropdown/dropdown.hbs */ "./src/components/dropdown/dropdown.hbs"),(depth0 != null ? lookupProperty(depth0,"dropdown") : depth0),{"name":"../dropdown/dropdown","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "</div>";
},"usePartial":true,"useData":true});

/***/ }),

/***/ "./src/pages/signin/signin.hbs":
/*!*************************************!*\
  !*** ./src/pages/signin/signin.hbs ***!
  \*************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div\r\n    style='display: flex; height: 100vh; flex-direction: column; justify-content: center; align-items: center;'\r\n>\r\n    <div class='signin-page'>\r\n        <div class='left-block'>\r\n            <span class='text-regular'>Войдите, чтобы использовать все\r\n                возможности</span>\r\n            <div class='cell'>\r\n                <svg\r\n                    width='25'\r\n                    height='25'\r\n                    viewBox='0 0 64 64'\r\n                    fill='var(--text-secondary)'\r\n                    xmlns='http://www.w3.org/2000/svg'\r\n                >\r\n                    <path\r\n                        d='M32 8C46.4457 8 58.2857 18.1486 58.2857 30.8571C58.2857 43.5657 46.4457 53.7143 32 53.7143C28.9028 53.7143 25.8788 53.248 23.0308 52.3497C19.8263 55.3349 15.1268 56.9074 9.03313 57.1451C8.47497 57.167 7.9205 57.0458 7.42233 56.7931C6.92417 56.5404 6.49885 56.1646 6.18673 55.7014C5.87462 55.2381 5.68607 54.7028 5.63899 54.1462C5.5919 53.5896 5.68784 53.0302 5.9177 52.5211C7.99998 47.9154 9.14741 44.5257 9.37827 42.512C6.99884 39.024 5.71427 35.024 5.71427 30.8571C5.71427 18.1486 17.5543 8 32 8ZM32 12.5714C19.936 12.5714 10.2857 20.8434 10.2857 30.8571C10.2857 34.304 11.4217 37.6114 13.5451 40.4869C13.8377 40.8824 13.9948 41.3618 13.9931 41.8537C13.984 44.2469 12.9646 47.7211 10.9531 52.4297C15.4948 51.9543 18.6971 50.5303 20.656 48.2309C20.9607 47.8741 21.3679 47.6197 21.8222 47.5024C22.2766 47.385 22.756 47.4103 23.1954 47.5749C25.9428 48.6034 28.9234 49.1429 32 49.1429C44.064 49.1429 53.7143 40.8709 53.7143 30.8571C53.7143 20.8434 44.064 12.5714 32 12.5714Z'\r\n                    />\r\n                </svg>\r\n                <span\r\n                    class='text-regular'\r\n                    style='color: var(--text-secondary);'\r\n                >Общение об объявлениях в чатах</span>\r\n            </div>\r\n\r\n            <div class='cell'>\r\n                <svg\r\n                    width='25'\r\n                    height='25'\r\n                    viewBox='0 0 64 64'\r\n                    fill='var(--text-secondary)'\r\n                    xmlns='http://www.w3.org/2000/svg'\r\n                >\r\n                    <path\r\n                        d='M32 4.57144C47.1474 4.57144 59.4286 16.8526 59.4286 32C59.4286 47.1474 47.1474 59.4286 32 59.4286C16.8526 59.4286 4.57141 47.1474 4.57141 32C4.57141 16.8526 16.8526 4.57144 32 4.57144ZM32 9.14287C19.376 9.14287 9.14284 19.376 9.14284 32C9.14284 44.624 19.376 54.8572 32 54.8572C44.624 54.8572 54.8571 44.624 54.8571 32C54.8571 19.376 44.624 9.14287 32 9.14287ZM35.824 19.4286C38.0442 19.4286 40.1735 20.3106 41.7435 21.8805C43.3134 23.4505 44.1954 25.5798 44.1954 27.8C44.1954 30.0203 43.3134 32.1496 41.7435 33.7195C40.1735 35.2895 38.0442 36.1714 35.824 36.1714L30.2057 36.1692V39.376H33.9474C34.4436 39.376 34.9195 39.5731 35.2703 39.924C35.6212 40.2748 35.8183 40.7507 35.8183 41.2469C35.8183 41.7431 35.6212 42.2189 35.2703 42.5698C34.9195 42.9206 34.4436 43.1177 33.9474 43.1177L30.2057 43.1154V44.8983C30.2057 45.4178 29.9993 45.9161 29.632 46.2834C29.2646 46.6508 28.7664 46.8572 28.2468 46.8572H27.9268C27.4073 46.8572 26.9091 46.6508 26.5417 46.2834C26.1744 45.9161 25.968 45.4178 25.968 44.8983L25.9657 43.1154H23.9726C23.4767 43.1154 23.0011 42.9185 22.6505 42.5678C22.2998 42.2172 22.1028 41.7416 22.1028 41.2457C22.1028 40.7499 22.2998 40.2743 22.6505 39.9236C23.0011 39.573 23.4767 39.376 23.9726 39.376H25.9657V36.1692H24.0617C23.5426 36.1692 23.0447 35.9631 22.6774 35.5962C22.3101 35.2294 22.1034 34.7317 22.1028 34.2126V33.856C22.1028 32.7726 22.9806 31.8972 24.0617 31.8972L25.9657 31.8949V21.3874C25.9657 20.3063 26.8457 19.4286 27.9268 19.4286H35.824ZM35.9063 23.3463H30.2057V31.8949H35.9063C37.0399 31.8949 38.1271 31.4445 38.9286 30.643C39.7302 29.8414 40.1806 28.7542 40.1806 27.6206C40.1806 26.487 39.7302 25.3998 38.9286 24.5982C38.1271 23.7966 37.0399 23.3463 35.9063 23.3463Z'\r\n                    />\r\n                </svg>\r\n                <span\r\n                    class='text-regular'\r\n                    style='color: var(--text-secondary);'\r\n                >Бесплатное размещение объявлений</span>\r\n            </div>\r\n            <div class='cell'>\r\n                <svg\r\n                    width='25'\r\n                    height='25'\r\n                    viewBox='0 0 64 64'\r\n                    fill='var(--text-secondary)'\r\n                    xmlns='http://www.w3.org/2000/svg'\r\n                >\r\n                    <path\r\n                        d='M30.8206 3.43316C31.6206 3.31887 32.3794 3.31887 33.1794 3.43316C33.968 3.54744 34.6263 3.72344 36.1417 4.22859L51.7303 9.42401C52.6409 9.72732 53.433 10.3096 53.9942 11.0882C54.5555 11.8669 54.8574 12.8025 54.8571 13.7623V34.9714C54.8571 45.9292 48.2789 54.3246 35.5246 59.9817L34.6834 60.3474C33.8348 60.7083 32.9221 60.8943 32 60.8943C31.0778 60.8943 30.1652 60.7083 29.3166 60.3474C16.016 54.6972 9.14285 46.176 9.14285 34.9714V13.76C9.1431 12.8006 9.44522 11.8655 10.0064 11.0873C10.5676 10.3091 11.3594 9.7272 12.2697 9.42401L28.288 4.08687C29.5063 3.68916 30.1097 3.53373 30.8206 3.43316ZM32.5349 7.95887C32.1803 7.90577 31.8197 7.90577 31.4651 7.95887C31.008 8.02516 30.5783 8.14173 29.3029 8.56459L13.7143 13.7623V34.9714C13.7143 44.1509 19.3623 51.1497 31.1063 56.1417C31.6777 56.384 32.3223 56.384 32.8777 56.1486L33.6869 55.7966C44.8937 50.8252 50.2857 43.9452 50.2857 34.9714V13.76L34.3383 8.44801C33.8383 8.27146 33.3285 8.12416 32.8114 8.00687L32.5349 7.95887Z'\r\n                    />\r\n                    <path\r\n                        d='M43.5589 24.4412C43.1302 24.0127 42.549 23.7719 41.9429 23.7719C41.3368 23.7719 40.7555 24.0127 40.3269 24.4412L29.1429 35.6252L24.816 31.2983C24.3849 30.882 23.8075 30.6516 23.2082 30.6568C22.6089 30.662 22.0356 30.9024 21.6119 31.3262C21.1881 31.7499 20.9477 32.3232 20.9425 32.9225C20.9373 33.5218 21.1676 34.0992 21.584 34.5303L27.5269 40.4732C27.9555 40.9017 28.5368 41.1424 29.1429 41.1424C29.749 41.1424 30.3302 40.9017 30.7589 40.4732L43.5589 27.6732C43.9874 27.2445 44.2281 26.6633 44.2281 26.0572C44.2281 25.4511 43.9874 24.8698 43.5589 24.4412Z'\r\n                    />\r\n                </svg>\r\n                <span\r\n                    class='text-regular'\r\n                    style='color: var(--text-secondary);'\r\n                >Покупки со скидкой по безопасной сделке</span>\r\n            </div>\r\n        </div>\r\n        <div class='right-block'>\r\n            <div class='right-block-content'>\r\n                <button data-link='/' class='logo'>\r\n                    <div\r\n                        style='background-image: url(assets/icons/logo.svg); width: 60px; height: 60px;'\r\n                    ></div>\r\n                </button>\r\n                <span class='text-subheader'>Вход в «Юла»</span>\r\n                <input\r\n                    id='inputEmail'\r\n                    class='text-regular'\r\n                    placeholder='Электронная почта'\r\n                    type='text'\r\n                    style='width: 100%;'\r\n                />\r\n                <input\r\n                    id='inputPass'\r\n                    class='text-regular'\r\n                    placeholder='Пароль'\r\n                    type='password'\r\n                    style='width: 100%;'\r\n                />\r\n                <div id='errorBox'></div>\r\n                <button\r\n                    id='btnSubmit'\r\n                    class='btn-primary'\r\n                    style='width: -webkit-fill-available;'\r\n                >\r\n                    <span class='text-regular'>"
    + alias2(alias1(((stack1 = (depth0 != null ? lookupProperty(depth0,"buttons") : depth0)) != null ? lookupProperty(stack1,"submit") : stack1), depth0))
    + "</span>\r\n                </button>\r\n                <button\r\n                    data-link='/signup'\r\n                    class='btn-neutral'\r\n                    style='width: -webkit-fill-available;'\r\n                >\r\n                    <p class='text-regular'>"
    + alias2(alias1(((stack1 = (depth0 != null ? lookupProperty(depth0,"buttons") : depth0)) != null ? lookupProperty(stack1,"toReg") : stack1), depth0))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div\r\n    style='display: flex; height: 100vh; flex-direction: column; justify-content: center; align-items: center;'\r\n>\r\n    <div\r\n        style='display: flex; width: 400px; padding: 16px; flex-direction: column; justify-content: center; align-items: center; gap: 16px; flex-shrink: 0; border-radius: 12px; border: 1px solid var(--text-tertiary, rgba(41, 44, 47, 0.25));'\r\n    >\r\n        <div\r\n            id='content'\r\n            style='display: flex; flex-direction: column; align-items: center; gap: 16px; align-self: stretch;'\r\n        >\r\n            <button\r\n                data-link='/'\r\n                style='display: flex; width: 60px; height: 60px; justify-content: center; align-items: center; border-radius: 12px; border: 1px solid var(--background-tertiary, rgba(41, 44, 47, 0.12));'\r\n            >\r\n                <div\r\n                    style='background-image: url(assets/icons/logo.svg); width: 60px; height: 60px;'\r\n                ></div>\r\n            </button>\r\n            <p class='text-subheader'>Регистрация в «Юла»</p>\r\n            <input\r\n                id='inputEmail'\r\n                class='text-regular'\r\n                placeholder='Электронная почта'\r\n                type='text'\r\n                class='inputField'\r\n            />\r\n            <input\r\n                id='inputPass'\r\n                class='text-regular'\r\n                placeholder='Пароль'\r\n                type='password'\r\n                class='inputField'\r\n            />\r\n            <input\r\n                id='inputPassRepeat'\r\n                class='text-regular'\r\n                placeholder='Повтор пароля'\r\n                type='password'\r\n                class='inputField'\r\n            />\r\n            <div id='errorBox'></div>\r\n            <button\r\n                id='btnSubmit'\r\n                class='btn-primary'\r\n                style='width: -webkit-fill-available;'\r\n            >\r\n                <p class='text-regular'>"
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? lookupProperty(depth0,"buttons") : depth0)) != null ? lookupProperty(stack1,"submit") : stack1), depth0))
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _pages_main_main_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pages/main/main.js */ "./src/pages/main/main.js");
/* harmony import */ var _pages_signin_signin_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/signin/signin.js */ "./src/pages/signin/signin.js");
...
/* harmony import */ var _shared_store_store_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shared/store/store.js */ "./src/shared/store/store.js");
/* harmony import */ var _shared_services_router_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shared/services/router.js */ "./src/shared/services/router.js");
/**
 * @file main.js
 * @module Main
 */
...
_shared_store_store_js__WEBPACK_IMPORTED_MODULE_3__.store.user.init();
window.Router = new _shared_services_router_js__WEBPACK_IMPORTED_MODULE_4__.Router([new _shared_services_router_js__WEBPACK_IMPORTED_MODULE_4__.Route('/', new _pages_main_main_js__WEBPACK_IMPORTED_MODULE_0__.MainPage()), new _shared_services_router_js__WEBPACK_IMPORTED_MODULE_4__.Route('/signin', new _pages_signin_signin_js__WEBPACK_IMPORTED_MODULE_1__.SigninPage()), new _shared_services_router_js__WEBPACK_IMPORTED_MODULE_4__.Route('/signup', new _pages_signup_signup_js__WEBPACK_IMPORTED_MODULE_2__.SignupPage())]);
})();
